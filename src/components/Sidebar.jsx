...
const NAV = [
  {
    ...
    icon: (
      <svg viewBox="0 0 20 20" fill="currentColor">
        <path d="M2 10.5a1.5 1.5 0 113 0v6a1.5 1.5 0 01-3 0v-6zM6 10.333a1 1 0 011-1h1a1 1 0 011 1v6.334a1 1 0 01-1 1H7a1 1 0 01-1-1v-6.334zm5-6a1 1 0 011-1h1a1 1 0 011 1v12.334a1 1 0 01-1 1h-1a1 1 0 01-1-1V4.333z"/>
      </svg>
    ),
  },
  {
...
export default function Sidebar({ fpos, selectedFpo, onFpoChange }) {
      ...
      <div className="sb-brand">
        <div className="sb-icon">
          <svg viewBox="0 0 32 32" fill="none">
            ...
            <path d="M16 4C9.4 4 4 9.4 4 16s5.4 12 12 12" stroke="white" strokeWidth="2" strokeLinecap="round"/>
            <path d="M16 4c6.6 0 12 5.4 12 12s-5.4 12-12 12" stroke="rgba(255,255,255,0.5)" strokeWidth="2" strokeLinecap="round"/>
